...
import game.doodads.Platform;
	public class Level_Level_7 extends BaseLevel
	{
		//Embedded media...
		[Embed(source="../../../assets/mapCSV_Level_7_blocks.csv", mimeType="application/octet-stream")] public var CSV_blocks:Class;
		...
		public function addSpritesForLayerPlatforms(onAddCallback:Function = null):void
		{
			...
			addSpriteToLayer("normal", null, Platform, PlatformsGroup , 112.000, 160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"type", value:"normal" }, null ), onAddCallback );//"Platform"
			addSpriteToLayer("one-off", null, Platform, PlatformsGroup , 64.000, 64.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"type", value:"one-off" }, null ), onAddCallback );//"Platform"
			...
			addSpriteToLayer("one-off", null, Platform, PlatformsGroup , 192.000, 160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"type", value:"one-off" }, null ), onAddCallback );//"Platform"
			addSpriteToLayer("normal", null, Platform, PlatformsGroup , 192.000, 96.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"type", value:"normal" }, null ), onAddCallback );//"Platform"
			addSpriteToLayer("one-off", null, Platform, PlatformsGroup , 160.000, 64.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"type", value:"one-off" }, null ), onAddCallback );//"Platform"
		}
